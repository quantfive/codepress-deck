...
const versionsData = [
  {
    section: "In progress",
    items: [{ id: 1, name: "Untitled", status: "Copy", date: "May 30, 2025" }],
  },
  {
    section: "Previous",
    items: [
      { id: 2, name: "Project Name", status: "Published", date: "Apr 2, 2025" },
    ],
  },
];
                ...
                {section.items.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-1 w-30 shrink-0">
                      <div
                        className={`flex w-6 h-6 items-center justify-center rounded-md shrink-0 bg-green-100`}
                      ></div>
