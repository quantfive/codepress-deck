import { computePosition as I, offset as J, shift as K, flip as N, size as Q, hide as T, limitShift as X, arrow as z } from "./index165.js";
import { autoUpdate as pe, platform as ge } from "./index165.js";
